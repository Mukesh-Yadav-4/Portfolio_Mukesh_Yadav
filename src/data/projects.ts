...
export const PROJECTS_DATA: Project[] = [
  // 1. ECG STRESS DETECTION (Flagship Paper)
  {
    ...
    featured: true,
    statusBadge: "Zenodo Preprint",
    badgeColor: "cyan",
    date: "2026",
    summary:
      "Mitigated inter-subject baseline variability across 15 WESAD benchmark subjects using relative baseline calibration: X* = (X - Bs) / |Bs|. Evaluated with Leave-One-Subject-Out (LOSO) validation on authentic 700 Hz Lead-II chest telemetry.",
    publication: {
  ...
  url       = {https://doi.org/10.5281/zenodo.22806710}
    ...
    metrics: [
      ...
      { label: "Feature Extraction", value: "<0.85 ms*", subtext: "Benchmark platform" },
    ],
